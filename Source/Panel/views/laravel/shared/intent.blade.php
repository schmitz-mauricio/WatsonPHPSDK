<div class="form-group ">
    ...
    <input name="intent" id="intent" value="{{ isset($oIntent) ? $oIntent->getIntent() : '' }}" class="form-control" placeholder="" style="" required="required" title="" type="hidden">
    <input name="intent_description" id="intent_description" value="{{ isset($oIntent) ? $oIntent->getDescription() : '' }}" class="form-control" placeholder="" style="" required="required" title="" type="text">
</div>
...
<div class="form-group examplesToCopy toClone" id="examplesToCopy{{ isset($oIntent) ? $oIntent->getIntent() : '' }}">
    <input name="examples[]" id="examples" value="" class="form-control callClick" data-callclick-target="#copyExample{{ isset($oIntent) ? $oIntent->getIntent() : '' }}" placeholder="" style="" required="required" title="" type="text">
    <a href="#" class="trash-example"><span class="glyphicon glyphicon-trash"></span></a>
</div>
